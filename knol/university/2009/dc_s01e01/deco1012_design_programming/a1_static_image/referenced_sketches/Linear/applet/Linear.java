...
float intHeadWidth=(height/1.5f-initHeadWidth)/starMax; //changing intHeadWidth to conform with starMax when headWidth has been calculated
float xInterval=0.1f; // the accuracy of the pixels in the image
...
saveFrame("Linear.jpg");
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Linear" });
  }
}
