...
while (squareState==0) {
  ...
  diam *= 1.15f; // diameter unit increases each time; hence squares get bigger towards the right
  if (squareX>width){
...
saveFrame("Snake.jpg");
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "Snake" });
  }
}
