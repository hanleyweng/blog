...
var _premdom; // the protocol & domain name of the remote server
var _premsecdom;  // the protocol & domain name of the remote HTTPS server

var _domparts = window.location.hostname.split("\.");

var _tmpdom = "";
if(_domparts.length>=3)
{
    for(var i=_domparts.length-3; i<_domparts.length; i++)
    {
        _tmpdom += "." + _domparts[i];
    }
}else{
	_tmpdom=".sydney.edu.au";
}


// Edit this section to add more domain names if there are others not already accounted for
switch(_tmpdom)
{
        case '.sydney.edu.au':
                _premdom = 'http://stats.sydney.edu.au';
                _premsecdom = 'https://ssl-stats.sydney.edu.au';
                _udn = 'sydney.edu.au';
                break;
        default:
                _premdom = 'http://stats.usyd.edu.au';
                _premsecdom = 'https://ssl-stats.usyd.edu.au';
                _udn='usyd.edu.au';
                break;
}
...
var _ugifpath2=_premdom + "/__utm.gif";
if (_udl.hash) _udlh=_udl.href.substring(_udl.href.indexOf('#'));
//if (_udl.protocol=="https:") _ugifpath2="https://ssl.google-analytics.com/__utm.gif";
if (_udl.protocol=="https:") _ugifpath2=_premsecdom + "/__utm.gif";
...
function _uInfo(page,opt) {
 ...
 pg=_udl.hostname+_udl.pathname+_udl.search;
 ...
 if ((_userv==0 || _userv==2) && _uSP()) {
  var i=new Image(1,1);
   ...
   //i.src=_premdom +_ugifpath+"?"+"utmwv="+_uwv+s;
   i.src=_ugifpath2+"?"+"utmwv="+_uwv+s;
